...
void InitMap() {
	...
	WriteChar(67, 10, "键位控制：", 0);
	WriteChar(67, 11, "w:上移", 0);
	WriteChar(67, 12, "s:下移", 0);
	WriteChar(67, 13, "a:左移", 0);
	WriteChar(67, 14, "d:右移", 0);
	WriteChar(67, 15, "space:加速", 0);
	WriteChar(67, 20, "p键暂停", 0);
